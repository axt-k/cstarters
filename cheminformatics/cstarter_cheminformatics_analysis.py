...
def cli() -> argparse.Namespace:
    ...
    # Required arguments
    parser.add_argument("--data", "-d", type=str, required=True, help="path to the input data csv file")
    parser.add_argument("--out-dir", "-o", type=str, required=True, help="output directory to save the results")
    ...
    parser.add_argument("--log-file", "-f", type=str, default=None, help="path to the log file (default: None, only logs to stdout)")
...
def main() -> None:
    ...
    pcs = plot_starter_pca(args.out_dir, ax1, records)
    ...
    pca_csv_path = os.path.join(args.out_dir, "pca_coordinates_with_smiles.csv")
    ...
    path_out_png = os.path.join(args.out_dir, "cstarter_cheminformatics_analysis.png")
    path_out_svg = os.path.join(args.out_dir, "cstarter_cheminformatics_analysis.svg")
